(() => {
  ...
  function renderGameHeader() {
    ...
    const codePanel = `
      <div class="game-code-panel ${current === 0 ? "game-code-start" : ""}">
        <div class="game-code-main">
          ...
          <div class="game-code-help">${current === 0
            ? "Jetzt teilen oder vorlesen. Sobald die Spurensuche startet, bleibt der Code nur noch über „Spielcode anzeigen“ aufrufbar."
            : "Diesen Code könnt ihr vorlesen oder unter „Mit Code beitreten“ eingeben."}</div>
        </div>
  ...
  function renderCompassHelp(targetStation, summaryText = "Navigation öffnen") {
    const label = String(summaryText || "Navigation öffnen")
      .replace("Kompass & ", "")
      .replace("Kompass ", "");
    ...
    return `
      <section class="final-card memory-finale">
        ...
        <section class="section memory-step">
          ...
          <input id="finalCrewCameraInput" type="file" accept="image/*" capture="user" hidden>
  ...
  async function createCertificateMemory() {
    ...
    try {
      ...
      ctx.fillText("AKTE 1823", 0, -17, 158);
      ctx.font = canvasFont(19, "Georgia, serif", "bold");
      ctx.fillText("GESCHLOSSEN", 0, 23, 166);
      ctx.restore();
